...
FORCE_SUB = os.environ.get("FORCE_SUB", "RR_BOTS_UPDATES") 

             # Don't Remove Credit @RR_BOTS_UPDATES
             # Subscribe YouTube Channel For Amazing Bot @RR_BOTS_UPDATES
             # Ask Doubt on telegram @RR_BOTS_UPDATES
